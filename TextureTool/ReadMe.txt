================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TextureTool Project Overview
===============================================================================

The application wizard has created this TextureTool application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TextureTool application.
...
TextureTool.h
    ...
    CTextureToolApp application class.

TextureTool.cpp
    This is the main application source file that contains the application
    class CTextureToolApp.
...
res\TextureTool.ico
    ...
    icon is included by the main resource file TextureTool.rc.
...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in TextureTool.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////
...
TextureTool_Document.h, TextureTool_Document.cpp - the document
    ...
    The Document will have the following strings:
        ...
        Main frame caption:  GLToy TextureTool
        Doc type name:       Texture
        Filter name:         TextureTool Files (*.ptx)
...
StdAfx.h, StdAfx.cpp
    ...
    named TextureTool.pch and a precompiled types file named StdAfx.obj.

Resource.h
    This is the standard header file, which defines new resource IDs.
    Microsoft Visual C++ reads and updates this file.

TextureTool.manifest
